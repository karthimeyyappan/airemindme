...
public class CustomerFieldSettingsRequest {
    ...
    public CustomerFieldSettingsRequest() {}

    public CustomerFieldSettingsRequest(String field1Name, String field2Name, String field3Name, String field4Name, String field5Name) {
