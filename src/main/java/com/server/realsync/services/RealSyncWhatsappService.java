...
public class RealSyncWhatsappService {
        ...
        public kong.unirest.HttpResponse<String> sendDocumentReadyTemplate(
                ...
                components.put("body_2",
                                Map.of("type", "text", "value", documentType != null ? documentType : "Document"));
        ...
        public kong.unirest.HttpResponse<String> sendAppointmentTemplate(
                ...
                components.put("body_2",
                                Map.of("type", "text", "value",
                                                appointmentConfirmation != null ? appointmentConfirmation : ""));
                components.put("body_3",
                                Map.of("type", "text", "value", appointmentNumber != null ? appointmentNumber : ""));
